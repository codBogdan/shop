...
public class CartController {
    ...
    @PutMapping
    public ResponseEntity addProductToCart(@RequestBody @Valid AddProductToCartRequest request) throws ResourceNotFoundException {
        cartService.addProductToCart(request);
        return new ResponseEntity(HttpStatus.NO_CONTENT);
    }
    @GetMapping("/{customerId}")
    public ResponseEntity<CartDto> getCart(@PathVariable("customerId") Long customerId) throws ResourceNotFoundException {
